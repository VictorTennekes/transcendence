...
export class GameService {
	...
	private async saveGameInDatabase(id: string) {
		...
		players[0].gameData.ballHits += gameData.players[game.users.one.id].hits;
		players[1].gameData.ballHits += gameData.players[game.users.two.id].hits;
		...
		players[0].gameData.points.won += gameData.players[game.users.one.id].score;
		players[0].gameData.points.lost += gameData.players[game.users.two.id].score;

		players[1].gameData.points.won += gameData.players[game.users.two.id].score;
		players[1].gameData.points.lost += gameData.players[game.users.one.id].score;
